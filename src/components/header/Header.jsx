        ...
        <div className="w-full sticky top-0 z-50">
            <div className="bg-amazon_blue mx-auto  text-white px-4 py-3 flex items-center gap-4">
                ...
                <div className="flex flex-col items-start justify-center headerHover">
                    <p className="text-sm mdl:text-xs  font-light text-white mdl:text-lightText">Hello, Sign in</p>
                    <p className="text-sm font-semibold text-whiteText -mt-1 hidden mdl:flex">Accounts & Lists {" "}<span><IoMdArrowDropdown className="mt-1 ml-2 w-5 h-5" /></span></p>
                </div>
